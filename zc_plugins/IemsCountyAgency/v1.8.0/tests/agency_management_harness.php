...
$assert($manifest['pluginVersion'] === 'v1.8.0', 'Manifest should identify plugin version v1.8.0.');
...
foreach (array_diff($previousFiles, $intentionallyChangedFiles) as $relativePath) {
    ...
    $assert(
        ...
        'v1.7.0 behavior changed unexpectedly: ' . $relativePath
    );
}
