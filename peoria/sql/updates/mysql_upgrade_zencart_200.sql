...
# * @version $Id: DrByte 2024 Aug 23 Modified in v2.1.0-alpha2 $
#
...
UPDATE address_book SET entry_agency='FAKE ACCOUNT' WHERE entry_agency LIKE '%src=%';
...
UPDATE address_book SET entry_unit='FAKE ACCOUNT' WHERE entry_unit LIKE '%src=%';
...
UPDATE address_book SET entry_agency=REPLACE(entry_agency, '<script', '_scrpt_') WHERE entry_agency LIKE '%<script%';
...
UPDATE address_book SET entry_unit=REPLACE(entry_unit, '<script', '_scrpt_') WHERE entry_unit LIKE '%<script%';
...
UPDATE orders SET customers_agency='FAKE ACCOUNT' WHERE customers_agency LIKE '%src=%';
...
UPDATE orders SET customers_unit='FAKE ACCOUNT' WHERE customers_unit LIKE '%src=%';
...
UPDATE orders SET delivery_agency='FAKE ACCOUNT' WHERE delivery_agency LIKE '%src=%';
...
UPDATE orders SET delivery_unit='FAKE ACCOUNT' WHERE delivery_unit LIKE '%src=%';
...
UPDATE orders SET billing_agency='FAKE ACCOUNT' WHERE billing_agency LIKE '%src=%';
...
UPDATE orders SET billing_unit='FAKE ACCOUNT' WHERE billing_unit LIKE '%src=%';
...
UPDATE orders SET customers_agency=REPLACE(customers_agency, '<script', '_scrpt_') WHERE customers_agency LIKE '%<script%';
...
UPDATE orders SET customers_unit=REPLACE(customers_unit, '<script', '_scrpt_') WHERE customers_unit LIKE '%<script%';
...
UPDATE orders SET delivery_agency=REPLACE(delivery_agency, '<script', '_scrpt_') WHERE delivery_agency LIKE '%<script%';
...
UPDATE orders SET delivery_unit=REPLACE(delivery_unit, '<script', '_scrpt_') WHERE delivery_unit LIKE '%<script%';
...
UPDATE orders SET billing_agency=REPLACE(billing_agency, '<script', '_scrpt_') WHERE billing_agency LIKE '%<script%';
...
UPDATE orders SET billing_unit=REPLACE(billing_unit, '<script', '_scrpt_') WHERE billing_unit LIKE '%<script%';
