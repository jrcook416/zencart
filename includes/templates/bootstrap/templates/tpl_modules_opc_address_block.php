...
if (ACCOUNT_SUBURB === 'true') {
	...
	<?php 
			...
			echo iems_pull_down_menu("update_" . $address_name . "_suburb", $filtered_units, $address['suburb'], 'id ="suburb['$which']", class="form-control" data-live-search="true" data-width="100%" title="Nothing selected."');
}
