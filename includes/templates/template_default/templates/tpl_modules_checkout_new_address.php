...
<?php echo zen_draw_input_field('unit', '', zen_set_field_length(TABLE_ADDRESS_BOOK, 'entry_unit', '40') . ' id="unit" autocomplete="address-line2" placeholder="' . ENTRY_SUBURB_TEXT . '"'); ?>
<br class="clearBoth">
<?php
  }
?>
