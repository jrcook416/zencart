<?php
$define = [
    'MODULE_PAYMENT_PURCHASE_ORDER_TEXT_TITLE' =>'Purchase Order',
    'MODULE_PAYMENT_PURCHASE_ORDER_TEXT_DESCRIPTION' =>'
...
',
    'MODULE_PAYMENT_PURCHASE_ORDER_TEXT_EMAIL_FOOTER' =>'IMPORTANT PAYMENT INFORMATION:' . "\n" .
