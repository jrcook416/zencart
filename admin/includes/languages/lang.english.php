...
$define = [
    ...
    'BUTTON_SAVE_ALL' => 'Save All Changes',
    ...
    'ENTRY_CITY' => 'City:',
    'ENTRY_CITY_ERROR' => '&nbsp;<span class="errorText">min ' . zen_config('ENTRY_CITY_MIN_LENGTH') . ' chars</span>',
    ...
    'ENTRY_EMAIL_ADDRESS_ERROR' => '&nbsp;<span class="errorText">min ' . zen_config('ENTRY_EMAIL_ADDRESS_MIN_LENGTH') . ' chars</span>',
    ...
    'ENTRY_FIRST_NAME_ERROR' => '&nbsp;<span class="errorText">min ' . zen_config('ENTRY_FIRST_NAME_MIN_LENGTH') . ' chars</span>',
    'ENTRY_GENDER' => 'Gender:',
    'ENTRY_GENDER_ERROR' => '&nbsp;<span class="errorText">required</span>',
    'ENTRY_LAST_NAME' => 'Last Name:',
    'ENTRY_LAST_NAME_ERROR' => '&nbsp;<span class="errorText">min ' . zen_config('ENTRY_LAST_NAME_MIN_LENGTH') . ' chars</span>',
    ...
    'ENTRY_POST_CODE_ERROR' => '&nbsp;<span class="errorText">min ' . zen_config('ENTRY_POSTCODE_MIN_LENGTH') . ' chars</span>',
    ...
    'ENTRY_STREET_ADDRESS_ERROR' => '&nbsp;<span class="errorText">min ' . zen_config('ENTRY_STREET_ADDRESS_MIN_LENGTH') . ' chars</span>',
    ...
    'ERROR_FILETYPE_NOT_ALLOWED' => 'Error: File upload type not allowed (%1$s), use one of these, instead: %2$s. See &quot;Maximum Values&quot; settings.',
    ...
    'ERROR_FILE_NOT_SAVED' => 'Error: File upload could not be saved, error code %d.',
    'ERROR_FILE_TOO_BIG' => 'Warning: File is larger than allowed sizes. See &quot;Maximum Values&quot; settings.',
    'ERROR_FILE_TOO_BIG_INI' => 'Warning: File is larger than the allowed size. See the <code>upload_max_filesize</code> directive (%s) in the site\'s <code>php.ini</code>.',
    'ERROR_FILE_TOO_BIG_MAXSIZE' => 'Warning: File is larger than the allowed size. The maximum allowed size (%u bytes) was calculated.',
    ...
    'HEADER_TEXT_TIMEZONE' => 'Time/Zone',
    'HEADER_TITLE_ACCOUNT' => 'My Account',
    ...
    'HEADER_TITLE_VERSION' => 'Server Details',
    ...
    'IMAGE_ADD_BLANK_DISCOUNTS' => 'Add ' . zen_config('DISCOUNT_QTY_ADD') . ' Blank Discount Qty',
    'IMAGE_BACK' => 'Back',
    'IMAGE_CANCEL' => 'Cancel',
    ...
    'TEXT_MFA_SCAN_QR_CODE' => 'Scan this QR Code (or type the secret below, in all capital letters) into your Authenticator app, and type in the generated 6-digit code below.',
