...
$file = (isset($_POST['filename']) ? $_POST['filename'] : "IEMS-Order-Export-" . date('mdy-Hi') . $file_extension . "");
...
//**************************************************************
   ...
   if ($_POST['customers_telephone'] == 1) {
   ...
   if ($_POST['orders_status_export'] == 1) {
                            ...
                            <tr>
                                <td valign="top" style="padding-right:7px;">
                                    <table border="0" width="100%" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td valign="top"><span
                                                        class="pageHeading"><?php echo HEADING_SHIPPING_EXPORT_TITLE; ?></span>
                                            </td>
                                       ...
                                       <?php } //end if Success Message ?>
                                        ...
                                        <tr>
                                            <td colspan=2
                                                valign="top"><?php echo TEXT_SHIPPING_EXPORT_INSTRUCTIONS; ?></td>
                                        </tr>
                                    </table>
                                                       ...
                                                       <tr class="dataTableRow" onMouseOver="rowOverEffect(this)"
                                                           ...
                                                           <td class="dataTableContent"><a
                                                                       href="<?php echo zen_href_link(FILENAME_ORDERS, 'page=1&oID=' . $order_id . '&action=edit', 'NONSSL'); ?>"><img
                                                                           ...
                                                                           ALT="Preview Order Details"></a></td>
                                                       </tr>
                                                      <?php
                                                   ...
                                                   if (!isset($order_id)) {
                                                      ?>
                                                       <tr class="dataTableRow">
                                                           <td class="dataTableContent" align="center" colspan="30"><b>No
                                                                   new orders were found!</b></td>
                                                       </tr>
                                                   <?php } ?>
                                                   <?php
                                                            ...
                                                            <form name="download_csv" id="download_csv" method="post">
                                                               ...
                                                               <?php echo TEXT_EMAIL_EXPORT_FORMAT; ?><?php echo zen_draw_pull_down_menu('format', $available_export_formats, $format); ?>
                                                                ...
                                                                <table border="0" cellspacing="0" cellpadding="2">
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <input type="checkbox" name="savetofile"
                                                                                   value="1">Save file to server and
                                                                            automatically email to supplier.<br/>(if not
                                                                            saving to server you will be promoted to
                                                                    ...
                                                                    <tr>
                                                                        <td>Email Subject Line:&nbsp;<input type="text"
                                                                ...
                                                                <table border="0" cellspacing="0" cellpadding="2">
                                                                    <tr>
                                                                        <td><strong>Update Order Status on
                                                                                Export</strong><br/>(If this is set then
                                                                            the order status will update to what you
                                                                            select here after a successful export.)
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>
                                                                          ...
                                                                          <tr>
                                                                            <td>--><?php echo zen_draw_pull_down_menu('order_status_setting', $status_array, '5' , 'id="order_status_setting"'); ?></td>
                                                                    </tr>
                                                                </table>
                                                                <hr/>
                                                                <table border="0" cellspacing="0" cellpadding="2">
                                                                    <tr>
                                                                        <td><strong>Order Status Export Options</strong>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>
                                                                    ...
                                                                    <tr>
                                                                        <td><?php echo zen_draw_pull_down_menu('order_status', $status_array, '4', 'id="order_status"'); ?></td>
                                                                    </tr>
                                                                </table>
                                                                <hr>
                                                                <table border="0" cellspacing="0" cellpadding="2"
                                                                    ...
                                                                    <tr>
                                                                        <td colspan="2">
                                                                            <strong><?php echo HEADING_PREVIOUS_EXPORTS_TITLE; ?></strong><br>
                                                                           <?php echo TEXT_PREVIOUS_EXPORTS; ?>
                                                                            <br></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td><?php echo zen_draw_checkbox_field('dload_include', '1', $dload_include_checked); ?>
                                                               ...
                                                               <?php echo zen_draw_checkbox_field('shiptotal', '1', $shipping_total_checked); ?>
                                                               ...
                                                               <?php echo zen_draw_checkbox_field('order_comments', '1', $order_comments_checked); ?>
                                                                ...
                                                                <!--				<hr />-->
                                                               <?php echo zen_draw_checkbox_field('order_tax', '1', $order_tax_checked); ?>
                                                                &nbsp;<?php echo TEXT_TAX_AMOUNT_FIELD; ?><br/>
                                                               <?php echo zen_draw_checkbox_field('order_subtotal', '1', $order_subtotal_checked); ?>
                                                                &nbsp;<?php echo TEXT_SUBTOTAL_FIELD; ?><br/>
                                                               <?php echo zen_draw_checkbox_field('order_discount', '1', $order_discount_checked); ?>
                                                               ...
                                                               <?php echo zen_draw_checkbox_field('product_details', '1', $prod_details_checked=true); ?>
                                                                ...
                                                                <table border="0" cellspacing="0" cellpadding="2"
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td colspan="2">
                                                                            <strong><?php echo HEADING_CUSTOM_DATE_TITLE; ?></strong><br>
