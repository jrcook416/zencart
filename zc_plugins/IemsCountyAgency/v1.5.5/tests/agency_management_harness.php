...
$assert($manifest['pluginVersion'] === 'v1.5.5', 'Manifest should identify plugin version v1.5.5.');
...
$assert(
    ...
    'v1.5.5 must carry forward the complete v1.3.0 agency-management payload.'
);
