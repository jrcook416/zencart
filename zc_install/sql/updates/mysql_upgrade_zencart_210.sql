...
# * @version $Id: piloujp 2025 Feb 28 Modified in v2.2.0 $
#
...
ALTER TABLE address_book MODIFY entry_unit varchar(128) default NULL;
...
ALTER TABLE orders MODIFY customers_unit varchar(128) default NULL;
...
ALTER TABLE orders MODIFY delivery_unit varchar(128) default NULL;
...
ALTER TABLE orders MODIFY billing_unit varchar(128) default NULL;
