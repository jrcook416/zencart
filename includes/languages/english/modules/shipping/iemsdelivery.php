...
define('MODULE_SHIPPING_IEMSDELIVERY_TEXT_TITLE', 'Deliver to IEMS Location');
define('MODULE_SHIPPING_IEMSDELIVERY_TEXT_DESCRIPTION', '
...
See: freeshipper
');
define('MODULE_SHIPPING_IEMSDELIVERY_TEXT_WAY', 'Deliver to IEMS Location');
