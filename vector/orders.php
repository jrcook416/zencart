...
// create search filter
                  ...
                  $new_fields .= ", o.customers_company, o.customers_email_address, o.customers_street_address, o.delivery_unit, o.delivery_company, o.delivery_name, o.delivery_street_address, o.billing_company, o.billing_name, o.billing_street_address, o.payment_module_code, o.shipping_module_code, o.orders_status, o.ip_address, o.language_code ";
...
//    $orders_query_numrows = '';
                ...
                <td class="dataTableContent"><?php echo '<a href="' . zen_href_link(FILENAME_CUSTOMERS, 'cID=' . $orders->fields['customers_id'], 'NONSSL') . '">' . zen_image(DIR_WS_ICONS . 'preview.gif', ICON_PREVIEW . ' ' . TABLE_HEADING_CUSTOMERS) . '</a>&nbsp;'; ?>
                    ...
                    echo '<a href="' . zen_href_link(FILENAME_MAIL, 'origin=' . FILENAME_ORDERS . '&customer=' . $orders->fields['customers_email_address'] . '&cID=' . $orders->fields['customers_id']) . '">' . $orders->fields['delivery_name'] . (unit_name_lookup($orders->fields['delivery_unit']) != '' ? '<br />' . unit_name_lookup($orders->fields['delivery_unit']) : '') . '</a>';
                    ?>
                </td>
                <?php /* EOF Super Orders 16 of 21 */ ?>
