...
$define = [
    ...
    'CATEGORY_AGENCY' => 'Agency Details',
    ...
    'ENTRY_CITY' => 'City:',
    'ENTRY_CITY_ERROR' => 'Your City must contain a minimum of ' . zen_config('ENTRY_CITY_MIN_LENGTH') . ' characters.',
    'ENTRY_CITY_TEXT' => '*',
    'ENTRY_AGENCY' => 'Agency Name:',
    'ENTRY_AGENCY_ERROR' => 'Please enter an agency name.',
    'ENTRY_AGENCY_TEXT' => '',
    'ENTRY_COUNTY' => 'Indiana County',
    ...
    'ENTRY_EMAIL_ADDRESS_ERROR' => 'Is your email address correct? It should contain at least ' . zen_config('ENTRY_EMAIL_ADDRESS_MIN_LENGTH') . ' characters. Please try again.',
    ...
    'ENTRY_EMAIL_NAME_CHECK_ERROR' => 'Sorry, is your name correct? Our system requires a minimum of ' . zen_config('ENTRY_FIRST_NAME_MIN_LENGTH') . ' characters. Please try again.',
    'ENTRY_EMAIL_TEXT_DISPLAY' => 'TEXT-Only',
    'ENTRY_ENQUIRY' => 'Message:',
    'ENTRY_FAX_NUMBER' => 'Fax Number:',
    'ENTRY_FAX_NUMBER_TEXT' => '',
    'ENTRY_FIRST_NAME' => 'First Name:',
    'ENTRY_FIRST_NAME_ERROR' => 'Is your first name correct? Our system requires a minimum of ' . zen_config('ENTRY_FIRST_NAME_MIN_LENGTH') . ' characters. Please try again.',
    ...
    'ENTRY_LAST_NAME_ERROR' => 'Is your last name correct? Our system requires a minimum of ' . zen_config('ENTRY_LAST_NAME_MIN_LENGTH') . ' characters. Please try again.',
    ...
    'ENTRY_PASSWORD_ERROR' => 'Your Password must contain a minimum of ' . zen_config('ENTRY_PASSWORD_MIN_LENGTH') . ' characters.',
    'ENTRY_PASSWORD_ERROR_NOT_MATCHING' => 'The Password Confirmation must match your Password.',
    'ENTRY_PASSWORD_NEW' => 'New Password:',
    'ENTRY_PASSWORD_NEW_ERROR' => 'Your new Password must contain a minimum of ' . zen_config('ENTRY_PASSWORD_MIN_LENGTH') . ' characters.',
    'ENTRY_PASSWORD_NEW_ERROR_NOT_MATCHING' => 'The Password Confirmation must match your new Password.',
    'ENTRY_PASSWORD_NEW_TEXT' => '*',
    'ENTRY_PASSWORD_TEXT' => '* (at least ' . zen_config('ENTRY_PASSWORD_MIN_LENGTH') . ' characters)',
    'ENTRY_POST_CODE' => 'Post/Zip Code:',
    'ENTRY_POST_CODE_ERROR' => 'Your Post/ZIP Code must contain a minimum of ' . zen_config('ENTRY_POSTCODE_MIN_LENGTH') . ' characters.',
    ...
    'ENTRY_STATE_ERROR' => 'Your State must contain a minimum of ' . zen_config('ENTRY_STATE_MIN_LENGTH') . ' characters.',
    'ENTRY_STATE_ERROR_SELECT' => 'Please select a state from the States pull down menu.',
    'ENTRY_STATE_TEXT' => '*',
    'ENTRY_STREET_ADDRESS' => 'Street Address:',
    'ENTRY_STREET_ADDRESS_ERROR' => 'Your Street Address must contain a minimum of ' . zen_config('ENTRY_STREET_ADDRESS_MIN_LENGTH') . ' characters.',
    'ENTRY_STREET_ADDRESS_TEXT' => '*',
    'ENTRY_SUBURB' => 'Ordering Unit',
    'ENTRY_SUBURB_TEXT' => '',
    'ENTRY_UNIT' => 'Ordering Unit',
    'ENTRY_UNIT_TEXT' => '',
    'ENTRY_TELEPHONE_NUMBER' => 'Telephone Number:',
    'ENTRY_TELEPHONE_NUMBER_ERROR' => 'Your Telephone Number must contain a minimum of ' . zen_config('ENTRY_TELEPHONE_MIN_LENGTH') . ' characters.',
    ...
    'JS_REVIEW_TEXT' => '* Please add a few more words to your comments. The review needs to have at least ' . zen_config('REVIEW_TEXT_MIN_LENGTH') . ' characters.',
    ...
    'OUT_OF_STOCK_CANT_CHECKOUT' => 'Products marked with ' . zen_config('STOCK_MARK_PRODUCT_OUT_OF_STOCK') . ' are out of stock or there are not enough in stock to fill your order.<br>Please change the quantity of products marked with (' . zen_config('STOCK_MARK_PRODUCT_OUT_OF_STOCK') . '). Thank you',
    'OUT_OF_STOCK_CAN_CHECKOUT' => 'Products marked with ' . zen_config('STOCK_MARK_PRODUCT_OUT_OF_STOCK') . ' are out of stock.<br>Items not in stock will be placed on backorder.',
