...
class addCustomers extends base
{
                    ...
                    foreach ($lines as $line) {
                        ...
                        // Process data row
                            ...
                            $values = [
                                ...
                                'entry_county' => $this->getValue('county', $line),
                                'entry_agency' => $this->getValue('agency',$line),
                                'entry_unit' => $this->getValue('unit', $line),
    ...
    public function insertCustomer($info)
    {
        ...
        $entry_county = (isset($info['entry_county'])) ? zen_db_prepare_input($info['entry_county']) : '';
        $entry_agency = (isset($info['entry_agency'])) ? zen_db_prepare_input($info['entry_agency']) : '';
        $entry_unit = (isset($info['entry_unit'])) ? zen_db_prepare_input($info['entry_unit']) : '';
        ...
        $sql_data_array = [
           ...
           'entry_lastname'       => $customers_lastname,
            'entry_county'       => $entry_county,
            'entry_agency'       => $entry_agency,
