...
?>
            ...
            <label class="inputLabel" for="iems-agency-id"><?= $iemsAgencyLabel ?></label>
            <select name="iems_agency_id" id="iems-agency-id" class="form-control"<?= $iemsAgencyRequired ?>>
                <option value=""><?= htmlspecialchars($iemsPlaceholder, ENT_QUOTES, CHARSET, true) ?></option>
<?php
...
<script>
(() => {
    const countySelect = document.getElementById('iems-county-id');
    const agencySelect = document.getElementById('iems-agency-id');
