...
?>
    <div id="companyDetails-card" class="card mb-3">
        ...
        <div id="companyDetails-card-body" class="card-body p-3">
            ...
            <?php echo zen_draw_input_field('company', '', zen_set_field_length(TABLE_ADDRESS_BOOK, 'entry_company', '40') . ' id="company" autocomplete="organization" placeholder="' . ENTRY_COMPANY_TEXT . '"' . ((int)ENTRY_COMPANY_MIN_LENGTH !== 0 ? ' required disabled' : '')); ?>
        </div>
    </div>
<?php
}
