...
// hidden fields not changeable on products page
  ...
  <div class="form-group">
    ...
    <div class="col-sm-9 col-md-6">
        <?php echo zen_draw_pull_down_menu('artists_id', $artists_array, $pInfo->artists_id, 'class="form-control" id="artists_id"'); ?>
    </div>
  </div>
  <div class="form-group">
      <?php echo zen_draw_label(TEXT_PRODUCTS_RECORD_COMPANY, 'record_company_id', 'class="col-sm-3 control-label"'); ?>
    <div class="col-sm-9 col-md-6">
        <?php echo zen_draw_pull_down_menu('record_company_id', $record_company_array, $pInfo->record_company_id, 'class="form-control" id="record_company_id"'); ?>
    </div>
  </div>
  <div class="form-group">
      <?php echo zen_draw_label(TEXT_PRODUCTS_MUSIC_GENRE, 'music_genre_id', 'class="col-sm-3 control-label"'); ?>
    <div class="col-sm-9 col-md-6">
        <?php echo zen_draw_pull_down_menu('music_genre_id', $music_genre_array, $pInfo->music_genre_id, 'class="form-control" id="music_genre_id"'); ?>
    </div>
  </div>
  <div class="form-group">
...
?>
  ...
  <div class="well" style="color: #31708f;background-color: #d9edf7;border-color: #bce8f1;padding: 10px 10px 0 0;">
	...
	<div class="form-group">
      ...
      <div class="col-sm-9 col-md-6">
          <?php echo iems_pull_down_menu('products_price_uom', $pInfo->products_price_uom, 'onkeyup="updateUOM()" class="form-control selectpicker" id="products_price_uom"'); ?>
      </div>
    </div>
