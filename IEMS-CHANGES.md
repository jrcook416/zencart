...
- Upgrade through Plugin Manager from v1.6.0, then review the installed `iemspickup` module and enter its required street, city, and postcode settings before enabling pickup. Validation includes all v1.7.0 deterministic harnesses, unchanged v1.4.0-v1.6.0 harnesses, PHP lint, prior-version and template guards, and security/compatibility review.
