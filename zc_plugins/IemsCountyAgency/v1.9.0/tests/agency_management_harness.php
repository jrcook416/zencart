...
$assert($manifest['pluginVersion'] === 'v1.9.0', 'Manifest should identify plugin version v1.9.0.');
...
$previousRoot = dirname($pluginRoot) . '/v1.8.0';
$previousFiles = $relativeFiles($previousRoot);
$currentFiles = $relativeFiles($pluginRoot);
$assert(
    array_diff($previousFiles, $currentFiles) === [],
    'v1.9.0 must carry forward the complete v1.8.0 payload.'
);

$intentionallyChangedFiles = [
    'Installer/ScriptedInstaller.php',
    'admin/iems_agencies.php',
    'admin/includes/classes/IemsAgencyInput.php',
    'admin/includes/languages/english/lang.iems_agencies.php',
    ...
    'catalog/includes/languages/english/modules/shipping/lang.iemsdelivery.php',
...
foreach (array_diff($previousFiles, $intentionallyChangedFiles) as $relativePath) {
    ...
    $assert(
        ...
        'v1.8.0 behavior changed unexpectedly: ' . $relativePath
    );
}
