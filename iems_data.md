...
- **Unit delivery address composition (v1.9.2):** The order delivery address retains the customer's company, first name, and last name. Its suburb is the canonical selected unit label, and its street, city, postcode, Indiana state, and United States country come from the validated managed unit destination. Pickup retains its independently configured recipient/company.
