...
define('SUCCESS_ORDER_COMMENT_INSERTED','Order comment inserted.'); 
define('SUCCESS_ORDER_COMMENT_UPDATED','Order comment updated.'); 
define('SUCCESS_COMMENT_REMOVED','Order comment removed.'); 
