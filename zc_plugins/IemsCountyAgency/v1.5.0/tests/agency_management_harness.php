...
$assert($manifest['pluginVersion'] === 'v1.5.0', 'Manifest should identify plugin version v1.5.0.');
...
$assert(
    ...
    'v1.5.0 must carry forward the complete v1.3.0 agency-management payload.'
);
