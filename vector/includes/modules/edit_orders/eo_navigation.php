...
echo '</form>';?>
	...
	<?php
	company_lookup(); 
	echo iems_pull_down_menu('update_delivery_company',$company_array, $cInfo->entry_company, 'id ="company" style="background-color:yellow", form-control class="selectpicker" data-live-search="true"');?>
