...
6. includes/classes/Customer.php on 2023-01-09 to handle custom changes to the Customer class involving the address book on 2023-01-09.
7. Updated the MySQL schema with the addition of database tables for agency, county, and unit identifiers on 2023-01-10. 
