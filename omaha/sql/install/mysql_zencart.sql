...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Agency', 'ACCOUNT_AGENCY', 'true', 'Display agency field during account creation and with account information', 5, 3, 'zen_cfg_select_option([\'true\', \'false\'], ', now());
