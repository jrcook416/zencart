...
$assert($manifest['pluginVersion'] === 'v1.9.4', 'Manifest should identify plugin version v1.9.4.');
...
$assert(
    ...
    'v1.9.4 functional source must contain exactly the v1.9.2 payload.'
);
...
foreach ($behaviorFiles as $relativePath) {
    ...
    $assert(
        ...
        'v1.9.4 behavior differs unexpectedly from v1.9.2: ' . $relativePath
    );
}
