...
$assert($manifest['pluginVersion'] === 'v1.6.0', 'Manifest should identify plugin version v1.6.0.');
...
foreach (array_diff($previousFiles, $intentionallyChangedFiles) as $relativePath) {
    ...
    $assert(
        ...
        'v1.5.5 behavior changed unexpectedly: ' . $relativePath
    );
}
