 ...
 *
 * DESCRIPTION:   New class to handle all the tasks related to the data
 * of the customer. (i.e. addresses, passwords, personal info, store
 * admin feedback)
 *
  ...
  switch ($action) {
    ...
    case 'update':
      ...
      if ($error == false) {
        ...
        if (ACCOUNT_DOB == 'true')
          $sql_data_array['customers_dob'] = zen_date_raw($customers_dob);
