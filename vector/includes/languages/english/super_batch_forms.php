...
define('TEXT_NO_ORDER_HISTORY', 'No comments');
define('PACKING_SLIPS_MASTER_LIST', 'Master list of packing slips for selected orders');
define('PACKING_SLIPS_SELECTED_ORDERS', 'Packing slips for selected orders');
define('PACKING_SLIPS_MERGE_CUSTOMERS', 'Merge customer orders to the same shipping address');
define('PACKING_SLIPS_PRINT_OPTIONS', 'Printing Options');
define('PACKING_SLIPS_PDF_FORMS', 'PDF Packing Slip');
